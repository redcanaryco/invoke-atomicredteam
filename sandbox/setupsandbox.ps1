...
$scriptTmp = Join-Path $env:TEMP 'install-atomicredteam.ps1'
Invoke-WebRequest 'https://raw.githubusercontent.com/redcanaryco/invoke-atomicredteam/master/install-atomicredteam.ps1' -OutFile $scriptTmp
. $scriptTmp
